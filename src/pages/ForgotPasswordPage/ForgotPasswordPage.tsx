import React, { FC, FormEventHandler, SyntheticEvent } from "react";
...
const ForgotPasswordPage: FC = () => {
	...
	// @ts-ignore
	const { restorePasswordRequest, restorePasswordSuccess } = useSelector(store => store.auth);
	...
	return (
		<>
			{restorePasswordSuccess ? (
				<Navigate to={ROUTES.resetPassword} state={{from: location.pathname}}/>
			) : (
				<main>
