...
import IngredientDetailsPage
    from "../../pages/IngredientDetailsPage/IngredientDetailsPage";
import NotFoundPage from "../../pages/NotFoundPage/NotFoundPage";
import BaseLayout from "../../layouts/BaseLayout/BaseLayout";
import ProfileLayout from "../../layouts/ProfileLayout/ProfileLayout";
import ProfileInfoPage from "../../pages/ProfileInfoPage/ProfileInfoPage";
import ProtectedRouteElement
    from "../ProtectedRouteElement/ProtectedRouteElement";
import { getUser } from "../../store/actions/auth";
import ProtectedRouteForAuthElement
    from "../ProtectedRouteForAuthElement/ProtectedRouteForAuthElement";
        ...
        <>
            <Routes location={location.state?.background || location}>
                <Route path={ROUTES.main} element={<BaseLayout/>}>
                    ...
                    <Route
                        path={ROUTES.login}
                        element={<ProtectedRouteForAuthElement
                            element={<LoginPage/>}
                        />}
                    />
                    <Route
